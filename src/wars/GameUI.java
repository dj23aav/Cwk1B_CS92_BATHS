...
public class GameUI
{
    ...
    public void doMain()
    {
        ...
        // Default Constructore can be called
        myBattles = new SeaBattles(name); // create
        
        // In order to read List of Encounters from file, overloaded Constructor can be called
        ...
        while (choice != 0 )
        {
            ...
            {
       	       System.out.println("Enter the Encounter number");
            ...
            else if (choice == 10) // Task 7 only
            {
                ...
                // Check if myStudents2 is null (i.e., failed to load)
                if (myBattles2 != null) {
                    System.out.println("Successfully loaded data: " + myBattles2.toString());
                } else {
